const CACHE='dbt-v6-7-7-history-edit-logo';
const ASSETS=['/','/index.html','/manifest.webmanifest','/branding/app-logo.png','/branding/icon-192.png','/branding/icon-512.png'];
